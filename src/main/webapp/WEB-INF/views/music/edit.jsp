...
<body>
<div class="container">
  <h1>음악 ${ music.id > 0 ? "수정" : "등록" }</h1>
  <hr />
  <form:form method="post" modelAttribute="music">  
    <div class="form-group">
      <label>가수:</label>
      <form:input path="singer" class="form-control w200" />
    </div>
    <div class="form-group">
      <label>제목:</label>
    ...
    <div class="form-group">
      <label>장르:</label>
      <form:select path="genreId" class="form-control w200"
                   itemValue="id" itemLabel="genreName" items="${ genres }" />
    </div>
    <div class="form-group">
      <label>발매년도:</label>
    ...
    <div>
      ...
      <c:if test="${ music.id > 0 }">
        <a href="delete.do?id=${ music.id }" class="btn btn-danger" data-confirm-delete>
